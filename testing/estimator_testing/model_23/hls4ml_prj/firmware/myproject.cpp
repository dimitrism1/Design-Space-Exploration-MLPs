...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<weight2_t, 81>(w2, "w2.txt");
        nnet::load_weights_from_txt<bias2_t, 9>(b2, "b2.txt");
        nnet::load_weights_from_txt<weight5_t, 279>(w5, "w5.txt");
        nnet::load_weights_from_txt<bias5_t, 31>(b5, "b5.txt");
        nnet::load_weights_from_txt<weight8_t, 1209>(w8, "w8.txt");
        nnet::load_weights_from_txt<bias8_t, 39>(b8, "b8.txt");
        loaded_weights = true;
    }
#endif
